...
public class Función1_4_SobrecargaSuma {
	...
	public static int suma(int Puno, int Pdos) {
		return Puno * Pdos;
	}
	...
	public static void main(String[] args) {
		...
		int resultado = (int) suma(0.0 ,0.0);
		...
		// FUNCIÓN SOBRECARGADA DE SUMA QUE MUTIPLICA ENTEROS.
		System.out.println("Resultado de la multiplicación: " + suma(11, 7));
	}
}